...
OptionalDerivedFloat16 = derived_type("float16", optional=True)
...
DerivedUByteArray = derived_array("uint8")
...
OptionalDerivedUByteArray = derived_array("uint8", optional=True)
